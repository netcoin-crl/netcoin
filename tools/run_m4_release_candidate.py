#!/usr/bin/env python3
"""Run the M4 mainnet-readiness release-candidate gate."""
...
def main() -> int:
    ...
    parser.add_argument("--out", default="reports/m4_release_candidate_report.json")
    ...
    if args.dry_run:
        ...
        result = {
            ...
            "runs": runs,
            "strict_evidence_required_for_operational_m4": args.profile == "strict",
        }
