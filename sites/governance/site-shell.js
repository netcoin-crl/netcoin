(() => {
  ...
  function setMode(m) {
    ...
    if (m === 'labs' && location.hostname !== 'markets.netcoin.online') {
      location.href = 'https://markets.netcoin.online';
    }
  }
  function buildTools() {
