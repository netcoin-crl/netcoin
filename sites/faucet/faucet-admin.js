...
(() => {
  ...
  function meter(spent, cap){ const pct=cap?Math.min(100,Math.round(spent/cap*100)):0; return '<div class="meter"><i style="width:'+pct+'%"></i></div>'; }
  async function load(){
